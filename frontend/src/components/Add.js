    ...
    return (
        <div className="AddContent">
            ...
            { permission==='root' ? <>
                ...
                <Card className="AddType"><Card.Body><Link to="/api/ldap/excel/export/" className="LinkStyle"><span>Export excel    <DownloadingIcon fontSize="large"/></span></Link></Card.Body></Card></> :
            null }
        </div>
    )
}
